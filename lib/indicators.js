...
/* ---------- 日线汇总 ---------- */
function dailySummary(bars, winN = 20) {
...
module.exports = { sma, ema, macd, kdj, rsiWilder, dailySummary, intradaySummary, evaluateConfirmations, numHelpers: { last, lastNum } };
